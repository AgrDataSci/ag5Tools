...
#'downloaded files should be stored per years
#'
#'@param .date
#'Format dd-mm-YYYY
#'
...
#deprecated - folder is no passed to each function to avoid global variables
...
extract_period <- function(.agera5_folder,
                           .start_date,
                           .end_date,
                           .location_xy,
                           .var,
...
get_filepath <- function(.agera5_folder,
                         .var,
                         .statistic,
                         .date_to_search){
  # Available temperature statistics
  ...
  print(file_name)
  agera5_file_path <- paste(.agera5_folder,
                            var_to_search,
                            year_to_search,
                            file_name,
                            sep = "/")
